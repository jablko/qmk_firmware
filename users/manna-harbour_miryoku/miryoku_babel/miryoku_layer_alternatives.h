...
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_ENT),  LT(U_SYM,KC_BSPC), LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_MEDIA,KC_ESC),U_NP,              U_NP
...
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_M),      \
LT(U_BUTTON,KC_W), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            ALGR_T(KC_SLSH),   LT(U_BUTTON,KC_SCLN),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_SYM,KC_BSPC), LT(U_NUM,KC_ENT),  LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
KC_Q,              KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              KC_M,              \
KC_W,              KC_X,              KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            KC_SLSH,           KC_SCLN,           \
U_NP,              U_NP,              KC_ESC,            KC_TAB,            KC_SPC,            KC_BSPC,           KC_ENT,            KC_DEL,            U_NP,              U_NP
...
U_NP,              U_NP,              KC_DEL,            KC_ENT,            KC_BSPC,           KC_BSPC,           U_NA,              U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              KC_BSPC,           KC_BSPC,           KC_ENT,            KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           KC_INS,            \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,              KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            KC_DEL,            \
U_NP,              U_NP,              U_NA,              U_NA,              KC_BSPC,           KC_BSPC,           KC_ENT,            KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           CW_TOGG,           KC_INS,            KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,              KC_DEL,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
U_NP,              U_NP,              U_NA,              U_NA,              KC_BSPC,           KC_BSPC,           KC_ENT,            KC_DEL,            U_NP,              U_NP
